  ...
  return (
    <div className="space-y-6 animate-scale-in text-left">
          ...
          <div className="space-y-4 py-4">
            <div>
              <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider mb-1 text-slate-400">
                ...
                <span className="text-white">{groupPct.toFixed(0)}%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider mb-1 text-slate-400">
                ...
                <span className="text-white">{onlinePct.toFixed(0)}%</span>
              </div>
              <div className="w-full h-1.5 bg-neutral-900">
            ...
            <div>
              <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider mb-1 text-slate-400">
                ...
                <span className="text-white">{walkinPct.toFixed(0)}%</span>
              </div>
              <div className="w-full h-1.5 bg-neutral-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#0f0f12] border border-neutral-900 p-6 shadow-md flex flex-col justify-between">
          <div>
            <h4 className="text-xs font-black uppercase tracking-widest text-primary border-b border-neutral-900 pb-3 mb-4">
              Thống kê Vận hành
            </h4>
          ...
          <div className="space-y-4 py-4">
            <div className="flex justify-between items-center border-b border-neutral-850 pb-2">
              <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Tổng Check-in</span>
              <span className="text-sm font-black text-white">{stats ? stats.totalCheckIns : 0} lượt</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Tổng Check-out</span>
              <span className="text-sm font-black text-white">{stats ? stats.totalCheckOuts : 0} lượt</span>
            </div>
          </div>
        ...
        <div className="bg-[#0f0f12] border border-neutral-900 p-6 shadow-md flex flex-col justify-between">
          ...
          <div className="py-2">
            ...
            <div className="w-full h-2 bg-neutral-900 rounded-full overflow-hidden mb-4">
              <div 
        ...
        <div className="bg-[#0f0f12] border border-neutral-900 p-6 shadow-md flex flex-col justify-between">
          ...
          <div className="space-y-3 py-4">
            <button
              ...
              disabled={!stats}
              className="w-full py-3 bg-primary hover:bg-white text-white hover:text-black transition-colors duration-200 text-[10px] font-black uppercase tracking-widest border-none cursor-pointer flex items-center justify-center gap-2 shadow-md disabled:bg-neutral-900 disabled:text-slate-500 disabled:cursor-not-allowed"
            >
