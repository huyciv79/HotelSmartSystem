...
const StaffHeader = ({ currentUser, isManager, searchQuery, setSearchQuery }) => {
  ...
  return (
    <header className="sticky top-0 left-72 w-full h-20 bg-white/95 backdrop-blur-md border-b border-slate-200/85 shadow-sm z-10 flex items-center justify-between px-10 text-left">
      <div>
        <h2 className="text-slate-800 font-black text-base uppercase tracking-wider m-0">
          Elysian Hub
        </h2>
      ...
      <div className="flex items-center gap-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-64 pl-11 pr-4 py-2.5 bg-slate-100 border border-slate-200 rounded-none text-xs font-bold text-slate-800 outline-none placeholder:text-slate-400 focus:border-primary focus:bg-white transition-all"
          />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
            <div className="text-right">
              <span className="text-slate-800 text-xs font-black block uppercase tracking-wide">
